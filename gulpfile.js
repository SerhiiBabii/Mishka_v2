...
const cssIndexFiles = ['./source/styles/mainStyles/*.scss', './source/styles/index/**/*.scss'];

const cssCatalogFiles = ['./source/styles/mainStyles/*.scss', './source/styles/catalog/**/*.scss'];
...
gulp.task(
  ...
  gulp.series(
    'clean',
    gulp.parallel('styles:compileIndex', 'styles:compileCatalog', 'styles:compileForm', 'js', 'copy'),
    gulp.parallel('watch', 'server')
  )
);
